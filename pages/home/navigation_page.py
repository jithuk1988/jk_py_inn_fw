...
class NavigationPage(BasePage):
    ...
    _nav_org = ".//div[contains(@id,navtoolbar)]/div[contains(@id,navtoolbar)]/a[@aria-label='Organization']"
    ...
    _nav_proj = ".//div[contains(@id,navtoolbar)]/div[contains(@id,navtoolbar)]/a[@aria-label='Projects']"
    _nav_iss = ".//div[contains(@id,navtoolbar)]/div[contains(@id,navtoolbar)]/a[@aria-label='Issues']"
    _nav_res = ".//div[contains(@id,navtoolbar)]/div[contains(@id,navtoolbar)]/a[@aria-label='Resources']"
    ...
    _nav_dash = ".//div[contains(@id,navtoolbar)]/div[contains(@id,navtoolbar)]/a[@aria-label='Dashboards']"
